...
from .models import Item, Cart, CartItems, OrderPlaced
...
class CartModelTest(TestCase):
    def setUp(self):
        ...
        self.item = Item.objects.create(category="Veg", item_name="Burger", price=200)
...
class OrderPlacedModelTest(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username="testuser", password="testpass123")
        self.item = Item.objects.create(category="Non-Veg", item_name="Chicken", price=350)
...
class ViewTests(TestCase):
    def setUp(self):
        ...
        self.item = Item.objects.create(
            category="Veg", item_name="Samosa", price=30, image=dummy_image
        )
    ...
    def test_add_item_superuser_only(self):
